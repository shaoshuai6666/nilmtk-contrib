...
class TCN_attention_classification(Disaggregator):

    def __init__(self, params):

        #self.MODEL_NAME = "RNNattention"
        self.MODEL_NAME = "TCN_attention_classification"
    ...
    def partial_fit(self,train_main,train_appliances,do_preprocessing=True,**load_kwargs):
        ...
        print("...............TCN_attention_classification partial_fit running...............")
        ...
        for appliance_name, power in train_appliances:
            ...
            if train_main.size > 0:
                ...
                if len(train_main) > 10:
                    ...
                    filepath = 'TCN_attention_classification-temp-weights-'+str(random.randint(0,100000))+'.h5'
...
#         # 1D Conv
#         # print("input_data",input_data.shape)#(None, 99, 1)
...
#         # print("y",y.shape)#(None, 99, 512)

        y= TCN(nb_filters=256, kernel_size=4, dilations=[1, 2, 4, 8],return_sequences=True)(input_data)
        ...
        full_model = Model(inputs=input_data, outputs=[output, classification_output], name="TCN_attention_classification")
