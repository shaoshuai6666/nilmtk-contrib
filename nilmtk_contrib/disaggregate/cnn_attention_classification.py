...
class CNN_attention_classification(Disaggregator):

    def __init__(self, params):

        #self.MODEL_NAME = "RNNattention"
        self.MODEL_NAME = "CNN_attention_classification"
    ...
    def partial_fit(self,train_main,train_appliances,do_preprocessing=True,**load_kwargs):
        ...
        print("...............CNN_attention_classification partial_fit running...............")
        ...
        for appliance_name, power in train_appliances:
            ...
            if train_main.size > 0:
                ...
                if len(train_main) > 10:
                    ...
                    filepath = 'CNN_attention_classification-temp-weights-'+str(random.randint(0,100000))+'.h5'
    ...
    def return_network(self):
        ...
        full_model = Model(inputs=input_data, outputs=[output, classification_output], name="CNN_attention_classification")
