...
class SGN_classification(Disaggregator):

    def __init__(self, params):

        self.MODEL_NAME = "SGN_classification"
    ...
    def partial_fit(self,train_main,train_appliances,do_preprocessing=True,**load_kwargs):
        ...
        print("...............SGN_classification partial_fit running...............")
        ...
        for appliance_name, power in train_appliances:
            ...
            if train_main.size > 0:
                ...
                if len(train_main) > 10:
                    ...
                    filepath = 'SGN_classification-temp-weights-'+str(random.randint(0,100000))+'.h5'
    ...
    def disaggregate_chunk(self,test_main_list,model=None,do_preprocessing=True):
        ...
        for test_mains_df in test_main_list:
            ...
            for appliance in self.models:
                ...
                ##################
                #PLOTTING
                # self.classification_output_plot(prediction_classification,classify_testappliance)
    ...
    def return_network(self):
       ...
       # Classification subnetwork
        ...
        y = Conv1D(filters=30, kernel_size=10, activation='relu')(input_data)
        y = Conv1D(filters=30, kernel_size=8, activation='relu')(y)
        y = Conv1D(filters=40, kernel_size=6, activation='relu')(y)
        y = Conv1D(filters=50, kernel_size=5, activation='relu')(y)
        y = Conv1D(filters=50, kernel_size=5, activation='relu')(y)
        y = Conv1D(filters=50, kernel_size=5, activation='relu')(y)
        y = Flatten()(y)
        y = Dense(units=1024, activation='relu', kernel_initializer='he_normal')(y)
        ...
        full_model = Model(inputs=input_data, outputs=[output, classification_output], name="SGN_classification")
